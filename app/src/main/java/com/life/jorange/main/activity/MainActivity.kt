...
import com.life.jorange.event.EventListDialog
...
private const val ID_EVENT_LIST = 23
...
class MainActivity : BaseListActivity() {
    override fun handleItemClick(listInfo: ListInfo) {
        when (listInfo.id) {
            ...
            ID_EVENT_LIST -> EventListDialog(this).showDialog()
        }
    }
    ...
    override fun getItems(): MutableList<ListInfo> {
        ...
        items.add(ListInfo(ID_EVENT_LIST, "Event List"))
        return items
    }
}